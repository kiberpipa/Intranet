...
urlpatterns = patterns('',
    ...
    url(r'^livestream/$', 'intranet.www.views.livestream', name="livestream"),
    url(r'^livestream/newslide$', 'intranet.www.views.livestream_newslide', name="livestream_newslide"),
    ...
    url(r'^about/', 'intranet.www.views.about', name='about'),
