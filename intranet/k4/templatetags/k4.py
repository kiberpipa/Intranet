...
def print_event(form):
	return {'event': form }
register.inclusion_tag('k4/print_event.html')(print_event)

def form_event(form):
	return {'form': form }
register.inclusion_tag('k4/form_event.html')(form_event)

def box_reccurings(form):
    return {'form': form }
register.inclusion_tag('k4/box_reccurings.html')(box_reccurings)
