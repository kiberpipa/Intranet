...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.require_officers_on_duty'
        db.add_column('org_event', 'require_officers_on_duty',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=True)

        # Adding M2M table for field officers_on_duty on 'Event'
        db.create_table('org_event_officers_on_duty', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['org.event'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('org_event_officers_on_duty', ['event_id', 'user_id'])

    def backwards(self, orm):
        # Deleting field 'Event.require_officers_on_duty'
        db.delete_column('org_event', 'require_officers_on_duty')

        # Removing M2M table for field officers_on_duty on 'Event'
        db.delete_table('org_event_officers_on_duty')
    ...
    models = {
        ...
        'org.event': {
            ...
            'require_officers_on_duty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'org.lend': {
            ...
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 22, 0, 0)'}),
            'from_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 21, 0, 0)'}),
        ...
        'org.stickynote': {
            ...
            'chg_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {}),
            'post_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 21, 0, 0)'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['org.Tag']", 'null': 'True', 'blank': 'True'})
        },
        'org.tag': {
