...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.note'
        db.alter_column('org_event', 'note', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'Event.announce'
        db.alter_column('org_event', 'announce', self.gf('tinymce.models.HTMLField')(null=True))
    def backwards(self, orm):

        # Changing field 'Event.note'
        db.alter_column('org_event', 'note', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Event.announce'
        db.alter_column('org_event', 'announce', self.gf('django.db.models.fields.TextField')(null=True))
    models = {
        'auth.group': {
        ...
        'org.diary': {
            ...
            'chg_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 13, 0, 0)', 'db_index': 'True'}),
        ...
        'org.lend': {
            ...
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 14, 0, 0)'}),
            'from_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 13, 0, 0)'}),
        ...
        'org.stickynote': {
            ...
            'chg_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 18, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {}),
            'post_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 13, 0, 0)'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['org.Tag']", 'null': 'True', 'blank': 'True'})
        },
        'org.tag': {
