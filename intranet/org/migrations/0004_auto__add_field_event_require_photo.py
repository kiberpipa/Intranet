...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.require_photo'
        db.add_column('org_event', 'require_photo', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=True)


    def backwards(self, orm):
        
        # Deleting field 'Event.require_photo'
        db.delete_column('org_event', 'require_photo')
    ...
    models = {
        ...
        'org.diary': {
            ...
            'chg_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.date(2010, 12, 17)', 'db_index': 'True'}),
        ...
        'org.event': {
            ...
            'require_photo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'org.lend': {
            ...
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 18)'}),
            'from_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 17)'}),
        ...
        'org.stickynote': {
            ...
            'chg_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 22)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {}),
            'post_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2010, 12, 17)'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['org.Tag']", 'null': 'True', 'blank': 'True'})
        },
        'org.tag': {
