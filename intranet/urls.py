...
urlpatterns = patterns('',
    ...
    url(r'^comments/post/$', 'django.contrib.comments.views.comments.post_comment'),
    url(r'^ajax/index/events/$', 'intranet.www.views.ajax_index_events', name="ajax_events"),
    url(r'^ajax/index/events/(?P<year>\d{4})/(?P<week>\d+)/$', 'intranet.www.views.ajax_index_events', name="ajax_events_week"),
