...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.remote_id'
        db.add_column('video_video', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.remote_id'
        db.delete_column('video_video', 'remote_id')
