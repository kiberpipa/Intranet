...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.pub_date'
        db.alter_column('video_video', 'pub_date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'Video.pub_date'
        db.alter_column('video_video', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
