...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('video_video', 'title', self.gf('django.db.models.fields.CharField')(max_length=240, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.title'
        db.delete_column('video_video', 'title')
