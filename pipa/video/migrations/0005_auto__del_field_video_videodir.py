...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.videodir'
        db.delete_column('video_video', 'videodir')

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Video.videodir'
        raise RuntimeError("Cannot reverse this migration. 'Video.videodir' and its values cannot be restored.")
    models = {
        'auth.group': {
        ...
        'video.video': {
            ...
            'remote_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'unique': 'True', 'null': 'True'}),
